...
class HomeViewController: narrowBaseViewController, SearchModalViewControllerDelegate, UITableViewDelegate, UITableViewDataSource,UIViewControllerTransitioningDelegate {
